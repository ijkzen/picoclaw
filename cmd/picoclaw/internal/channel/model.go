...
func NewModel() (*Model, error) {
	...
	channels := []ChannelInfo{
		...
		},
		{
			...
			Configured:  cfg.Channels.OneBot.WSUrl != "" && cfg.Channels.OneBot.WSUrl != "ws://127.0.0.1:3001",
		...
		},
		{
			...
			Configured:  cfg.Channels.MaixCam.Host != "" && cfg.Channels.MaixCam.Host != "0.0.0.0",
		...
		},
		{
			...
			Configured:  cfg.Channels.WhatsApp.BridgeURL != "" && cfg.Channels.WhatsApp.BridgeURL != "ws://localhost:3001",
